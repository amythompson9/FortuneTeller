    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string siblings = "";
                ...
                Console.WriteLine("You can stop at anytime by entering 'Quit'.");
            ...
            //even number.
            int retireYears = 0;
                if (Convert.ToUInt16(userAge) % 2 == 1)
                {
                    retireYears = 37;
                }
                if (Convert.ToUInt16(userAge) % 2 == 0)
                {
                    retireYears = 73;
                }
                ...
                string money = " ";
                if (Convert.ToUInt16(birthMonth) < 1 || Convert.ToUInt16(birthMonth) > 12)
                {
                    money = "0.00 in the bank,";
                }
                else if (Convert.ToUInt16(birthMonth) >= 1 && Convert.ToUInt16(birthMonth) <= 4)
                {
                    money = "314.00 in the bank,";
                }
                else if (Convert.ToUInt16(birthMonth) >= 5 && Convert.ToUInt16(birthMonth) <= 8)
                {
                    money = "1,000,000.13 in the bank,";
                }
                else if (Convert.ToUInt16(birthMonth) >= 9 && Convert.ToUInt16(birthMonth) <= 12)
                {
